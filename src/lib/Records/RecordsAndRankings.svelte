                    ...
                    <Body>
                        {#each playerWeekTOPS as playerATWeekTOP, ix}
                            <Row>
                                ...
                                {/if}
                                <Cell class="center">{playerATWeekTOP.playerInfo.pos == 'DEF' ? playerATWeekTOP.playerID : playerATWeekTOP.nflInfo.espn.t[playerATWeekTOP.year].length > 1 ? nflTeams.find(t => t.espnAbbreviation == playerATWeekTOP.nflInfo.espn.t[playerATWeekTOP.year].find(w => w.firstWeek <= playerATWeekTOP.week && w.lastWeek >= playerATWeekTOP.week).team).sleeperID : playerATWeekTOP.playerInfo.wi[playerATWeekTOP.year][playerATWeekTOP.week] && playerATWeekTOP.playerInfo.wi[playerATWeekTOP.year][playerATWeekTOP.week].t ? playerATWeekTOP.playerInfo.wi[playerATWeekTOP.year][playerATWeekTOP.week].t : nflTeams.find(t => t.espnAbbreviation == playerATWeekTOP.nflInfo.espn.t[playerATWeekTOP.year][0]).sleeperID}</Cell>
                    ...
                    <Body>
                        {#each playerWeekMissedBests as playerATWeekMissedBest, ix}
                            <Row>
                                ...
                                <Cell class="center">{playerATWeekMissedBest.playerInfo.pos == 'DEF' ? playerATWeekMissedBest.playerID : playerATWeekMissedBest.nflInfo.espn.t[playerATWeekMissedBest.year].length > 1 ? nflTeams.find(t => t.espnAbbreviation == playerATWeekMissedBest.nflInfo.espn.t[playerATWeekMissedBest.year].find(w => w.firstWeek <= playerATWeekMissedBest.week && w.lastWeek >= playerATWeekMissedBest.week).team).sleeperID : playerATWeekMissedBest.playerInfo.wi[playerATWeekMissedBest.year][playerATWeekMissedBest.week] && playerATWeekMissedBest.playerInfo.wi[playerATWeekMissedBest.year][playerATWeekMissedBest.week].t ? playerATWeekMissedBest.playerInfo.wi[playerATWeekMissedBest.year][playerATWeekMissedBest.week].t : nflTeams.find(t => t.espnAbbreviation == playerATWeekMissedBest.nflInfo.espn.t[playerATWeekMissedBest.year][0]).sleeperID}</Cell>
