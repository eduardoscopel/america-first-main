                                ...
                                <Body>
                                    {#each playerWeekBests as playerWeekBest, ix}
                                        <Row>
                                            ...
                                            {/if}
                                            <Cell class="center">{playerWeekBest.playerInfo.pos == 'DEF' ? playerWeekBest.playerID : playerWeekBest.nflInfo.espn.t[playerWeekBest.year].length > 1 ? nflTeams.find(t => t.espnAbbreviation == playerWeekBest.nflInfo.espn.t[playerWeekBest.year].find(w => w.firstWeek <= playerWeekBest.week && w.lastWeek >= playerWeekBest.week).team).sleeperID : playerWeekBest.playerInfo.wi[playerWeekBest.year][playerWeekBest.week].t ? playerWeekBest.playerInfo.wi[playerWeekBest.year][playerWeekBest.week].t : nflTeams.find(t => t.espnAbbreviation == playerWeekBest.nflInfo.espn.t[playerWeekBest.year][0]).sleeperID}</Cell>
                                            {#if masterSelection == 'alltime'}
                                ...
                                <Body>
                                    {#each playerWeekMissedBests as playerWeekMissedBest, ix}
                                        <Row>
                                            ...
                                            {/if}
                                            <Cell class="center">{playerWeekMissedBest.playerInfo.pos == 'DEF' ? playerWeekMissedBest.playerID : playerWeekMissedBest.nflInfo.espn.t[playerWeekMissedBest.year].length > 1 ? nflTeams.find(t => t.espnAbbreviation == playerWeekMissedBest.nflInfo.espn.t[playerWeekMissedBest.year].find(w => w.firstWeek <= playerWeekMissedBest.week && w.lastWeek >= playerWeekMissedBest.week).team).sleeperID : playerWeekMissedBest.playerInfo.wi[playerWeekMissedBest.year][playerWeekMissedBest.week].t ? playerWeekMissedBest.playerInfo.wi[playerWeekMissedBest.year][playerWeekMissedBest.week].t : nflTeams.find(t => t.espnAbbreviation == playerWeekMissedBest.nflInfo.espn.t[playerWeekMissedBest.year][0]).sleeperID}</Cell>
                                            {#if masterSelection == 'alltime'}
